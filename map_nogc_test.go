...
func BenchmarkNogcMap_Set(b *testing.B) {
    b.ReportAllocs()
...
func BenchmarkNogcMap_Get(b *testing.B) {
    big := memory_tile.GenBigStruct(0)

    m := NewNogcMap(memory_tile.Lecture{})
...
func BenchmarkNogcMap_Get_Ptr(b *testing.B) {
    big := memory_tile.GenBigStruct(0)
...
func BenchmarkNogcMap_Fetch(b *testing.B) {
    big := memory_tile.GenBigStruct(0)
